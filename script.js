...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.getElementById('model-filter').addEventListener('change', function(e) {
...
function showPage(pageName) {
  ...
  document.getElementById('research-nav').classList.remove('active');
  document.getElementById('leaderboard-nav').classList.remove('active');
...
function renderLeaderboard() {
  ...
  sorted.forEach(entry => {
    ...
    row.innerHTML = `
      ...
      <td class="px-6 py-4 whitespace-nowrap text-slate-grey">
        ${entry.size}
      </td>
      <td class="px-6 py-4 whitespace-nowrap">
